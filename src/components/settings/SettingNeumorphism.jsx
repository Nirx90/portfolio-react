...
export default function SettingNeumorphism() {
  ...
  const themes = [
...

    {
      name: "Mid Sapphire",
      color: "#0f172a",
      BoxShadow: "8px 8px 16px #090f1d, -8px -8px 16px #1e293b",
      InsetBoxShadow: "inset 4px 4px 8px #090f1d, inset -4px -4px 8px #1e293b",
      IconColor: "#bae6fd",
      TextColor: "#e0f2fe",
      DarkMode: true,
      type: "classic",
    },
    {
      name: "Crimson Velvet",
      color: "#7f1d1d",
      BoxShadow: "8px 8px 16px #4c0d0d, -8px -8px 16px #b22d2d",
      InsetBoxShadow: "inset 4px 4px 8px #4c0d0d, inset -4px -4px 8px #b22d2d",
      IconColor: "#fecaca",
      TextColor: "#fee2e2",
      DarkMode: true,
      type: "classic",
    },
    {
      name: "Royal Amethyst",
      color: "#4c1d95",
      BoxShadow: "8px 8px 16px #2e1159, -8px -8px 16px #6a29d1",
      InsetBoxShadow: "inset 4px 4px 8px #2e1159, inset -4px -4px 8px #6a29d1",
      IconColor: "#ddd6fe",
      TextColor: "#ede9fe",
      DarkMode: true,
      type: "classic",
    },
    {
      name: "Deep Ocean",
      color: "#1e3a8a",
      BoxShadow: "8px 8px 16px #122550, -8px -8px 16px #2a4fc4",
      InsetBoxShadow: "inset 4px 4px 8px #122550, inset -4px -4px 8px #2a4fc4",
      IconColor: "#bfdbfe",
      TextColor: "#dbeafe",
      DarkMode: true,
      type: "classic",
    },
    {
      ...
      InsetBoxShadow: "inset 4px 4px 8px #0f172a, inset -4px -4px 8px #334155",
      IconColor: "#cbd5e1",
      TextColor: "#e2e8f0",
      DarkMode: true,
      type: "classic",
    },
    {
      name: "Emerald Depths",
      color: "#064e3b",
      BoxShadow: "8px 8px 16px #043025, -8px -8px 16px #086c51",
      InsetBoxShadow: "inset 4px 4px 8px #043025, inset -4px -4px 8px #086c51",
      IconColor: "#a7f3d0",
      TextColor: "#d1fae5",
      DarkMode: true,
      type: "classic",
    },
    {
      name: "Burnt Sienna",
      color: "#7c2d12",
      BoxShadow: "8px 8px 16px #4a1b0b, -8px -8px 16px #ae3f19",
      InsetBoxShadow: "inset 4px 4px 8px #4a1b0b, inset -4px -4px 8px #ae3f19",
      IconColor: "#fed7aa",
      TextColor: "#ffedd5",
      DarkMode: true,
      type: "classic",
    },
    {
      name: "Twilight Plum",
      color: "#581c87",
      BoxShadow: "8px 8px 16px #34114f, -8px -8px 16px #7c27bf",
      InsetBoxShadow: "inset 4px 4px 8px #34114f, inset -4px -4px 8px #7c27bf",
      IconColor: "#e9d5ff",
      TextColor: "#f3e8ff",
      DarkMode: true,
      type: "classic",
    },
    {
      name: "Slate Horizon",
      color: "#334155",
      BoxShadow: "8px 8px 16px #1e293b, -8px -8px 16px #475569",
      InsetBoxShadow: "inset 4px 4px 8px #1e293b, inset -4px -4px 8px #475569",
      IconColor: "#cbd5e1",
      TextColor: "#e2e8f0",
      DarkMode: true,
      type: "classic",
    },
    {
      name: "Deep Wine",
      color: "#831843",
      BoxShadow: "8px 8px 16px #4e0e28, -8px -8px 16px #b8225e",
      InsetBoxShadow: "inset 4px 4px 8px #4e0e28, inset -4px -4px 8px #b8225e",
      IconColor: "#fbcfe8",
      TextColor: "#fce7f3",
      DarkMode: true,
      type: "classic",
    },
    {
      ...
      InsetBoxShadow: "inset 4px 4px 8px #d1d5db, inset -4px -4px 8px #ffffff",
      IconColor: "#4b5563",
      TextColor: "#1f2937",
      DarkMode: false,
      type: "classic",
    },
    {
      name: "Sky Mist",
      color: "#e0f2fe",
      BoxShadow: "8px 8px 16px #bae6fd, -8px -8px 16px #ffffff",
      InsetBoxShadow: "inset 4px 4px 8px #bae6fd, inset -4px -4px 8px #ffffff",
      IconColor: "#0369a1",
      TextColor: "#0c4a6e",
      DarkMode: false,
      type: "classic",
    },
    {
      name: "Pale Rose",
      color: "#fce7f3",
      BoxShadow: "8px 8px 16px #fbcfe8, -8px -8px 16px #ffffff",
      InsetBoxShadow: "inset 4px 4px 8px #fbcfe8, inset -4px -4px 8px #ffffff",
      IconColor: "#be185d",
      TextColor: "#831843",
      DarkMode: false,
      type: "classic",
    },
    {
      name: "Mint Frost",
      color: "#ecfdf5",
      BoxShadow: "8px 8px 16px #d1fae5, -8px -8px 16px #ffffff",
      InsetBoxShadow: "inset 4px 4px 8px #d1fae5, inset -4px -4px 8px #ffffff",
      IconColor: "#047857",
      TextColor: "#064e3b",
      DarkMode: false,
      type: "classic",
    },
    {
      name: "Golden Sand",
      color: "#fef3c7",
      BoxShadow: "8px 8px 16px #fde68a, -8px -8px 16px #ffffff",
      InsetBoxShadow: "inset 4px 4px 8px #fde68a, inset -4px -4px 8px #ffffff",
      IconColor: "#b45309",
      TextColor: "#78350f",
      DarkMode: false,
      type: "classic",
    },
    {
      name: "Lavender Haze",
      color: "#f5f3ff",
      BoxShadow: "8px 8px 16px #ede9fe, -8px -8px 16px #ffffff",
      InsetBoxShadow: "inset 4px 4px 8px #ede9fe, inset -4px -4px 8px #ffffff",
      IconColor: "#6d28d9",
      TextColor: "#5b21b6",
      DarkMode: false,
      type: "classic",
    },
    {
      name: "Pearl White",
      color: "#fafafa",
      BoxShadow: "8px 8px 16px #e5e5e5, -8px -8px 16px #ffffff",
      InsetBoxShadow: "inset 4px 4px 8px #e5e5e5, inset -4px -4px 8px #ffffff",
      IconColor: "#525252",
      TextColor: "#262626",
      DarkMode: false,
      type: "classic",
    },
    {
      name: "Soft Peach",
      color: "#ffedd5",
      BoxShadow: "8px 8px 16px #fed7aa, -8px -8px 16px #ffffff",
      InsetBoxShadow: "inset 4px 4px 8px #fed7aa, inset -4px -4px 8px #ffffff",
      IconColor: "#9a3412",
      TextColor: "#7c2d12",
      DarkMode: false,
      type: "classic",
    },
    {
      name: "Powder Blue",
      color: "#eff6ff",
      BoxShadow: "8px 8px 16px #dbeafe, -8px -8px 16px #ffffff",
      InsetBoxShadow: "inset 4px 4px 8px #dbeafe, inset -4px -4px 8px #ffffff",
      IconColor: "#1d4ed8",
      TextColor: "#1e40af",
      DarkMode: false,
      type: "classic",
    ...
    {
      name: "Royal Velvet",
      color: "linear-gradient(135deg, #4b0082, #6a5acd, #9370db, #ba55d3)",
      BoxShadow: "8px 8px 16px #2e004d, -8px -8px 16px #c77dff",
      InsetBoxShadow: "inset 4px 4px 8px #2e004d, inset -4px -4px 8px #c77dff",
      IconColor: "#e9d5ff",
      TextColor: "#f3e8ff",
      DarkMode: true,
      type: "gradient",
    ...
    {
      name: "Ocean Depths",
      color: "linear-gradient(135deg, #00008b, #1e90ff, #00bfff, #87cefa)",
      BoxShadow: "8px 8px 16px #00004d, -8px -8px 16px #add8e6",
      InsetBoxShadow: "inset 4px 4px 8px #00004d, inset -4px -4px 8px #add8e6",
      IconColor: "#bfdbfe",
      TextColor: "#e0f2fe",
      DarkMode: true,
      type: "gradient",
    ...
    {
      name: "Emerald Dream",
      color: "linear-gradient(135deg, #004d40, #00796b, #00897b, #4db6ac)",
      BoxShadow: "8px 8px 16px #00251a, -8px -8px 16px #80cbc4",
      InsetBoxShadow: "inset 4px 4px 8px #00251a, inset -4px -4px 8px #80cbc4",
      IconColor: "#a7f3d0",
      TextColor: "#d1fae5",
      DarkMode: true,
      type: "gradient",
    ...
    {
      name: "Mystic Purple",
      color: "linear-gradient(135deg, #4b0082, #800080, #9932cc, #ba55d3)",
      BoxShadow: "8px 8px 16px #2e004d, -8px -8px 16px #d8bfd8",
      InsetBoxShadow: "inset 4px 4px 8px #2e004d, inset -4px -4px 8px #d8bfd8",
      IconColor: "#e9d5ff",
      TextColor: "#f3e8ff",
      DarkMode: true,
      type: "gradient",
    ...
    {
      name: "Forest Canopy",
      color: "linear-gradient(135deg, #006400, #228b22, #2e8b57, #3cb371)",
      BoxShadow: "8px 8px 16px #003300, -8px -8px 16px #90ee90",
      InsetBoxShadow: "inset 4px 4px 8px #003300, inset -4px -4px 8px #90ee90",
      IconColor: "#bbf7d0",
      TextColor: "#dcfce7",
      DarkMode: true,
      type: "gradient",
    ...
    {
      name: "Crimson Tide",
      color: "linear-gradient(135deg, #8b0000, #b22222, #dc143c, #ff6347)",
      BoxShadow: "8px 8px 16px #4b0000, -8px -8px 16px #ff9999",
      InsetBoxShadow: "inset 4px 4px 8px #4b0000, inset -4px -4px 8px #ff9999",
      IconColor: "#fecaca",
      TextColor: "#fee2e2",
      DarkMode: true,
      type: "gradient",
    ...
    {
      name: "Twilight Zone",
      color: "linear-gradient(135deg, #191970, #4169e1, #6a5acd, #9370db)",
      BoxShadow: "8px 8px 16px #000080, -8px -8px 16px #b19cd9",
      InsetBoxShadow: "inset 4px 4px 8px #000080, inset -4px -4px 8px #b19cd9",
      IconColor: "#c7d2fe",
      TextColor: "#e0e7ff",
      DarkMode: true,
      type: "gradient",
    ...
    {
      name: "Mint Fresh",
      color: "linear-gradient(135deg, #3eb489, #50c878, #98ff98, #baf2bb)",
      BoxShadow: "8px 8px 16px #2d8b57, -8px -8px 16px #d8f8d8",
      InsetBoxShadow: "inset 4px 4px 8px #2d8b57, inset -4px -4px 8px #d8f8d8",
      IconColor: "#a7f3d0",
      TextColor: "#d1fae5",
      DarkMode: false,
      type: "gradient",
    ...
    {
      name: "Berry Blast",
      color: "linear-gradient(135deg, #8b008b, #9932cc, #ba55d3, #da70d6)",
      BoxShadow: "8px 8px 16px #4b0082, -8px -8px 16px #ffb6c1",
      InsetBoxShadow: "inset 4px 4px 8px #4b0082, inset -4px -4px 8px #ffb6c1",
      IconColor: "#f5d0fe",
      TextColor: "#fae8ff",
      DarkMode: true,
      type: "gradient",
    ...
    {
      name: "Desert Mirage",
      color: "linear-gradient(135deg, #cd853f, #d2b48c, #f5deb3, #faebd7)",
      BoxShadow: "8px 8px 16px #a0522d, -8px -8px 16px #fff8dc",
      InsetBoxShadow: "inset 4px 4px 8px #a0522d, inset -4px -4px 8px #fff8dc",
      IconColor: "#fde68a",
      TextColor: "#fef3c7",
      DarkMode: false,
      type: "gradient",
    ...
    {
      name: "Neon Nights",
      color: "linear-gradient(135deg, #ff00ff, #ff1493, #00ffff, #00ff00)",
      BoxShadow: "8px 8px 16px #8b008b, -8px -8px 16px #90ee90",
      InsetBoxShadow: "inset 4px 4px 8px #8b008b, inset -4px -4px 8px #90ee90",
      IconColor: "#f0abfc",
      TextColor: "#f5d0fe",
      DarkMode: true,
      type: "gradient",
    ...
    {
      name: "Copper Canyon",
      color: "linear-gradient(135deg, #b87333, #cd7f32, #d2691e, #e6ac00)",
      BoxShadow: "8px 8px 16px #804000, -8px -8px 16px #ffd700",
      InsetBoxShadow: "inset 4px 4px 8px #804000, inset -4px -4px 8px #ffd700",
      IconColor: "#fcd34d",
      TextColor: "#fef3c7",
      DarkMode: false,
      type: "gradient",
    ...
    {
      name: "Aqua Marine",
      color: "linear-gradient(135deg, #008080, #20b2aa, #40e0d0, #afeeee)",
      BoxShadow: "8px 8px 16px #006666, -8px -8px 16px #b0e0e6",
      InsetBoxShadow: "inset 4px 4px 8px #006666, inset -4px -4px 8px #b0e0e6",
      IconColor: "#99f6e4",
      TextColor: "#ccfbf1",
      DarkMode: false,
      type: "gradient",
    ...
    {
      name: "Lavender Mist",
      color: "linear-gradient(135deg, #9370db, #ba55d3, #d8bfd8, #e6e6fa)",
      BoxShadow: "8px 8px 16px #6a5acd, -8px -8px 16px #fff0f5",
      InsetBoxShadow: "inset 4px 4px 8px #6a5acd, inset -4px -4px 8px #fff0f5",
      IconColor: "#ddd6fe",
      TextColor: "#ede9fe",
      DarkMode: false,
      type: "gradient",
    ...
    {
      name: "Volcanic Glow",
      color: "linear-gradient(135deg, #8b0000, #b22222, #ff4500, #ff8c00)",
      BoxShadow: "8px 8px 16px #4b0000, -8px -8px 16px #ffa07a",
      InsetBoxShadow: "inset 4px 4px 8px #4b0000, inset -4px -4px 8px #ffa07a",
      IconColor: "#fecaca",
      TextColor: "#fee2e2",
      DarkMode: true,
      type: "gradient",
    ...
    {
      name: "Jungle Vibes",
      color: "linear-gradient(135deg, #006400, #228b22, #32cd32, #7cfc00)",
      BoxShadow: "8px 8px 16px #004d00, -8px -8px 16px #adff2f",
      InsetBoxShadow: "inset 4px 4px 8px #004d00, inset -4px -4px 8px #adff2f",
      IconColor: "#86efac",
      TextColor: "#bbf7d0",
      DarkMode: true,
      type: "gradient",
    ...
    {
      name: "Cosmic Dust",
      color: "linear-gradient(135deg, #000000, #4b0082, #9400d3, #ff00ff)",
      BoxShadow: "8px 8px 16px #000000, -8px -8px 16px #9932cc",
      InsetBoxShadow: "inset 4px 4px 8px #000000, inset -4px -4px 8px #9932cc",
      IconColor: "#c084fc",
      TextColor: "#e9d5ff",
      DarkMode: true,
      type: "gradient",
